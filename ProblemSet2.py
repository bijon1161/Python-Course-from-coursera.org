# -*- coding: utf-8 -*-
"""
Created on Fri May 14 19:43:24 2021
...
def problem2_1():
    ...
    print(lis)
    for i in lis:
        print(i,end=" ")# replace this pass (a do-nothing) statement with your code
...
def problem2_7():
    ...
    s= .5*(a+b+c)
    print("Area of a triangle with sides",a,b,c,"is",(s*(s-a)*(s-b)*(s-c))**.5)
    # replace this pass (a do-nothing) statement with your code
